...
export const ruCoreMessages: Messages = {
  ...
  'settings.appearance.themePresets': 'Готовые темы',
  'settings.appearance.themePresets.desc': 'Выберите палитру в стиле Copilot',
  'settings.appearance.themePresets.modalTitle': 'Готовые темы',
